...
CREATE TABLE `roles` (
  `idRol` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador de Rol con sus correspondientes permisos (Este campo es obligatorio).',
...
-- Dump completed on 2023-12-06 16:35:51
