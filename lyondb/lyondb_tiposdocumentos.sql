...
CREATE TABLE `tiposdocumentos` (
  `idTipoDocumento` tinyint(4) NOT NULL AUTO_INCREMENT COMMENT 'Llave foranea de tipo de identificacion de Usuario (Este campo es obligatorio).',
...
INSERT INTO `tiposdocumentos` VALUES (1,'c.c'),(2,'T.I'),(3,'P.E.'),(4,'Pasp'),(5,'C.E.');
